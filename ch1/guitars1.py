"""
Rick's search application (choices)
...
class Inventory:
    ...
    def search(self, search_guitar):
        ...
        for guitar in self._guitars:
            ...
            if model is not None and model != guitar.get_model().lower():
                continue
            if search_guitar.get_type() != guitar.get_type():
                continue
            if search_guitar.get_backwood() != guitar.get_backwood():
                continue
            if search_guitar.get_topwood() != guitar.get_topwood():
                continue
...
if __name__ == '__main__':
    ...
    if matching_guitars:
        ...
        for guitar in matching_guitars:
            print(" We have a " + str(guitar.get_builder()) + " " +
                  str(guitar.get_type()) + " guitar:\n    " +
                  str(guitar.get_backwood()) + " back and sides,\n    " +
                  str(guitar.get_topwood()) +
